...
GRANT UPVARCHAR(20), SELECT ON NHANVIEN TO p_NHANVIEN;

CREATE ROLE p_GIAMDOC;
GRANT SELECT ON DEAN TO p_GIAMDOC;
GRANT SELECT, UPVARCHAR(20) ON NHANVIEN TO p_GIAMDOC;
GRANT SELECT ON PHONGBAN TO p_GIAMDOC;

--Giam đốc được phép sửa các trường "lương, phụ cấp"
--cần viết ra procudure upVARCHAR(20) dữ liệu trên bảng nhân viên--
---------------------------------------
------------------------------------
