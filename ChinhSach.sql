...
AS
  FUNCTION ENCRYPT_LUONG(p_in IN varchar2,p_key IN VARCHAR2) 
    RETURN RAW DETERMINISTIC;
  FUNCTION DECRYPT_LUONG(p_in IN RAW,p_key IN VARCHAR2) 
...
UPDATE MAHOA_LUONG SET MAHOA_LUONG.HASHLUONG=ENC_DEC.ENCRYPT_SALARY(HASHLUONG,MANV||MANV);
UPDATE MAHOA_LUONG1 SET MAHOA_LUONG1.HASHLUONG=ENC_DEC.DECRYPT_SALARY(HASHLUONG,MANV||MANV);
select MANV, HONV, TENLOT, TENV, HASHLUONG from MAHOA_LUONG;